    ...
    <div className="bg-pink-100 flex  flex-col items-center  pt-4 pb-4 h-screen overflow-hidden">
      ...
      <div className="w-full max-w-2xl pl-4 pr-4 flex justify-between items-center gap-4 pb-4 ">
        ...
        <div className="bg-gray-300 flex items-center justify-center rounded-2xl p-4 w-full">
          <h2 className="size-10 flex items-center">Schedule</h2>
        </div>
      ...
      <div className=" w-full max-w-2xl  pl-4 pr-4 pb-4 flex justify-center items-center ">
        <h2 className="bg-yellow-200  p-4 border-2 border-yellow-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
</svg>
</h2>
        <input className=" p-4  border-2 border-yellow-300 w-full max-w-2xl  pl-4 pr-4 "></input>
        <button className="bg-yellow-200 p-4 border-2 border-yellow-300">
          Add
        </button>
      </div>
      <div className="grid grid-cols-3 grid-rows-3 gap-4 w-full max-w-2xl  pl-4 pr-4  aspect-square">
        ...
        <div className="bg-purple-300 flex items-center justify-center rounded-2xl">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
